...
//           <Link
//             href="/home"
//             className="flex items-center text-gray-800 dark:text-gray-200 hover:text-primary transition-colors duration-200"
//           >
...
//               <Link
//                 href={getPath(index)}
//                 className={`text-xs md:text-lg text-gray-800 dark:text-gray-200 hover:text-primary transition-colors duration-200 ${
...
export default function CustomBreadcrumb() {
  ...
  return (
    <nav aria-label="Breadcrumb" className="text-sm sm:text-base font-medium">
