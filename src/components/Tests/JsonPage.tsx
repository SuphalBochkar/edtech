...
//         {testName}
//       </h1>
//       <div className="w-full md:max-w-4xl p-2 md:p-4 md:rounded-lg bg-gray-800">
//         {/* {!error && id && ( */}
//         <>
//           <div className="sticky top-0 z-5 bg-gray-800 p-2">
...
//                 className="w-full p-2 rounded-md bg-gray-700 text-[14px] md:text-lg text-white search-input focus:outline-none focus:ring-1 focus:ring-white"
//               />
//               <button
//                 onClick={handleClear}
//                 className="px-4 py-2 text-[14px] md:text-lg rounded-md bg-gray-700 text-white active:bg-gray-500 focus:outline-none"
//               >
//                 Clear
//               </button>
//             </div>
...
//                       : "bg-gray-700 text-gray-200 hover:bg-gray-600 hover:text-white border-2 border-transparent"
//                   }`}
//                 >
//                   {filter}
//                 </div>
...
//             <div className="flex flex-col items-center justify-center py-10 bg-gray-900 rounded-md">
//               <div className="text-lg md:text-2xl font-semibold text-gray-300 mb-4 text-center">
//                 No Questions Found 😕
//               </div>
//               {/* {isProgramming() && (
//                   <div className="text-lg md:text-2xl font-semibold text-gray-300 mb-4 text-center">
...
//                   </div>
//                 )} */}
//               <div className="text-xs sm:text-sm md:text-base text-gray-300 text-center">
//                 Try adjusting your search terms or clearing the search input.
//               </div>
//               <button
//                 onClick={handleClear}
//                 className="mt-6 px-4 py-2 rounded-md bg-gray-700 text-white hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-400"
//               >
//                 Clear Search
//               </button>
//             </div>
...
//                 {question1 && (
//                   <div
//                     className="text-xs md:text-base text-white bg-gray-800 p-2 rounded-md"
...
//                   />
//                 )}
//                 <div className="text-xs md:text-lg text-white p-2 rounded-md">
//                   Options:
//                 </div>
//                 <ul className="text-xs md:text-base text-white pl-4 bg-gray-800 rounded-md p-3">
...
//                             ? "border md:border-2 px-2 rounded-md"
//                             : ""
//                         }`}
//                       >
...
//                   )}
//                 </ul>
//                 <h4 className="text-base md:text-lg text-white bg-gray-800 p-2 rounded-md my-2">
