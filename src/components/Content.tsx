  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center">
        <span className="tracking-tighter text-2xl md:text-3xl text-center font-medium text-[#f9fafb]">
          Welcome to
        </span>
        <h1 className="tracking-tighter text-6xl text-[#f9fafb] md:text-7xl xl:text-8xl text-center font-bold my-2">
          ...
          <span className="pl-4 block sm:inline">Hitbullsye.</span>
        </h1>
      </div>
      <p className="text-[#f9fafb] max-w-lg text-center tracking-tight md:text-lg font-light">
      ...
      <div className="flex gap-4">
        ...
        <button className="bg-gradient-to-r from-violet-400 text-sm sm:text-lg to-violet-500 px-6 py-2 rounded-md text-white font-semibold tracking-tight hover:from-violet-500 hover:to-violet-900">
          See Pricing
        </button>
        {/* <PricingButton /> */}
      </div>
