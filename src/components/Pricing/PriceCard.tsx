...
//             <span className="text-violet-100">₹{Course1_Hit_Amount}</span>
//           </span>
//         </p>
...
//             <p>Access answers for every test question.</p>
//           </li>
//           <li className="flex gap-x-3">
//             <Check className="text-violet-500" />
//             <p>Quickly search and locate specific questions.</p>
//           </li>
//           <li className="flex gap-x-3">
//             <Check className="text-violet-500" />
//             <p>A secure, reliable alternative to misleading sources.</p>
//           </li>
//           <li className="flex gap-x-3">
//             <Check className="text-violet-500" />
//             <p>
//               Get Access: Once registered, enjoy free access to all upcoming
//               tests.
//             </p>
//           </li>
//         </ul>
